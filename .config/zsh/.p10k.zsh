# Generated by Powerlevel10k configuration wizard on 2020-05-29 at 21:58 AEST.
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=240 # 240
  ...
  # ^    ^ 
  # |    |
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=31 # 31
  # If directory is too long, shorten some of its segments to the shortest possible unique
  # prefix. The shortened directory can be tab-completed to the original.
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique # truncate_to_unique
  ...
  #    ^   ^
  #    |   |
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=103 # 103
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  #~/file/path/file
  #              ^   
  #              |
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=39 # 39
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%76F'   # green foreground '%76F'
    ...
    # ?42 or U42 if have untracked files. It's really a question mark, your font isn't broken.
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=76 # 76
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=244 # 244
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=76 # 76
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=76 # 76
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=178 # 178
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=76F # 248 76F
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=37 # 37
  # Custom icon.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION='≡'

  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=178 # 178
  # Custom icon.
